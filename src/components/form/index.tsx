...
const FormValidator = () => {
    ...
    const professions = ['Test1', 'Test2', 'Other'];

    //formik validator classic
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            name: Yup.string()
                .label('Full Name')
                .required()
                .test('is-full-name', 'Please enter both your first and last name', function (value:any) {
    ...
    return (
        <div className="bg-grey-300 min-w-screen min-h-screen overflow-x-hidden">
